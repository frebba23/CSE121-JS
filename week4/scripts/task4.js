...
infor['photo'] = "images/My_Photo.jpg"
...
let infor = {
    ...
    photo: "images/freddy.jpg",
    
    favoriteFoods: ["Chicken", "Pizza", "Pork"],
    
    hobbies: ["Chess", "Darts", "Volleyball"],
...
function countPlaces(place) {
    placesOut += "<dt>" + place.place + "</dt>" + "<dt>" + place.timeLived + "years" + "</dt>";
}